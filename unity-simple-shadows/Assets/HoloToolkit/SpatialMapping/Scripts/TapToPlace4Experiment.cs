...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class TapToPlace4Experiment : MonoBehaviour, IInputClickHandler
    {
        ...
        // Haley: reference to custom SetWorldAnchor script
        SetWorldAnchor4Experiment setWorldAnchor; 
        ...
        protected virtual void Start()
        {
            ...
            // Haley: assign
            setWorldAnchor = transform.GetComponent<SetWorldAnchor4Experiment>(); 
        }
        ...
        protected virtual void Update()
        {
            ...
            // Haley: update UI position relative to anchor
            // Call SetWorldAnchor script on same gameobject
            setWorldAnchor.UpdateUITransform();
        }
