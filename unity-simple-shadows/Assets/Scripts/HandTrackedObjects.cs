...
public class HandTrackedObjects : MonoBehaviour //, INavigationHandler, ISourceStateHandler, IInputHandler, ISpeechHandler
{
    ...
    public List<GameObject> allObjects; // lazy. do this better later
    ...
    {
       curObject = allObjects[ShadowObjVars.shape_index];       
    } 
    ...
    private void InteractionManager_InteractionSourceDetected(InteractionSourceDetectedEventArgs args)
    {
        ...
        SetTrackingObject(); // not performant
        trackedHands.Add(id);
        activeId = id;
